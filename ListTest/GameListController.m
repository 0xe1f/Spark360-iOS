          ...
          atIndexPath:(NSIndexPath *)indexPath
{
    ...
    [label setText:[NSString localizedStringWithFormat:NSLocalizedString(@"GameAchievementStats", nil), 
                    [managedObject valueForKey:@"AchUnlocked"],
                    [managedObject valueForKey:@"AchTotal"]]];
    
    // Gamescore stats
    
    label = (UILabel*)[cell viewWithTag:5];
    [label setText:[NSString localizedStringWithFormat:NSLocalizedString(@"GameScoreStats", nil), 
                    [self.numberFormatter stringFromNumber:[managedObject valueForKey:@"PointsAcquired"]],
                    [self.numberFormatter stringFromNumber:[managedObject valueForKey:@"PointsTotal"]]]];
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    */
    ...
    //NSPredicate *predicate = [NSPredicate predicateWithFormat:@"(AccountId = %d)", 2]; // AKTODO
    
    // Edit the entity name as appropriate.
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"XboxPlayedGame" inManagedObjectContext:self.managedObjectContext];
